...
function TextShimmerComponent({
  ...
  return (
    <Component
      className={cn(
        "relative inline-block bg-[length:300%_100%,100%_100%] bg-clip-text",
        ...
        "[background-position:100%_center,0%_center] [-webkit-text-fill-color:transparent]",
        "[animation:shimmer_var(--duration)_linear_infinite] [animation-fill-mode:forwards]",
