...
import { Avatar, AvatarFallback } from "@sbkl-turborepo/ui/components/avatar";
import { Button } from "@sbkl-turborepo/ui/components/button";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
} from "@sbkl-turborepo/ui/components/collapsible";
...
export const CommitActions = ({
  ...
  <fieldset
    className={cn("flex items-center gap-1 border-none p-0 m-0", className)}
