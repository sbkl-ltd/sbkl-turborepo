...
import {
  ...
  DropdownMenuTrigger,
} from "@sbkl-turborepo/ui/components/dropdown-menu";
...
export const OpenInChatGPT = (props: OpenInChatGPTProps) => {
  ...
  return (
    <DropdownMenuItem
      render={
        // biome-ignore lint/a11y/useAnchorContent: content injected via DropdownMenuItem render prop
        <a
